...
router.get('/', async (req, res) => {
  try {
    ...
    // Open-Meteo is free and requires no API key, not sure if we want to use is just here for now
    const url = `https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&hourly=uv_index&forecast_days=1&timezone=America%2FVancouver`;
